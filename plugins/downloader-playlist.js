...
const handler = async (m, {conn, command, args, text, usedPrefix}) => {
  if (!text) throw _*< DESCARGAS - PLAY />*_\n\n*[ ℹ ] Hace falta el título o enlace del video de YouTube.*\n\n*[ 💡 ] Ejemplo:* _${usedPrefix + command} Good Feeling - Flo Rida_;
    ...
    throw '_< DESCARGAS - PLAY />*_\n\n[ ℹ ] Ocurrió un error. Por favor, inténtalo de nuevo más tarde.*';    
    }}
    if (command == 'play2') {
    try {   
